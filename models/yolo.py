...
class Model(nn.Module):
    ...
    def forward_once(self, x, profile=False):
        ...
        for m in self.model:
            ...
            if self.traced:
                if isinstance(m, Detect) or isinstance(m, IDetect) or isinstance(m, IDetect_Decoupled) or isinstance(m, IAuxDetect) or isinstance(m, IKeypoint):
                    break

            if profile:
                c = isinstance(m, (Detect, IDetect,IDetect_Decoupled, IAuxDetect, IBin))
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv,  RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
                 ...
                 SwinTransformer2Block, ST2CSPA, ST2CSPB, ST2CSPC,TRencoder,CBAM,fuseSPPCSPC,DCNv2,Conv_L,C3,C3TR,SAConv,CBH,DySnakeConv,DBH,RFEM,DiverseBranchBlock,GBH,GSPPCSPC
                 ]:
            c1, c2 = ch[f], args[0]
            ...
            if m in [DownC, SPPCSPC, GhostSPPCSPC, 
                     ...
                     ST2CSPA, ST2CSPB, ST2CSPC,TRencoder,fuseSPPCSPC,C3TR,C3,GSPPCSPC
                     ]:
            ...
            c2 = ch[f] // 2
        elif m in [Detect, IDetect,IDetect_Decoupled, IAuxDetect, IBin, IKeypoint]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='E:/yan/code/YOLO/yolov7/yolov7-main/cfg/training/yolov7-Biformer.yaml', help='model.yaml')
